...
public class HistoryAdapter extends CursorRecyclerViewAdapter<HistoryAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, Cursor cursor) {
        ...
        viewHolder.amountTxt.setText(String.format(mContext.getResources().getString(R.string.currency_amount), MySharedPreferences.getCurrency(mContext), Utils.formatDoubleTwoDecimalPlaces(item.getAmount())));
